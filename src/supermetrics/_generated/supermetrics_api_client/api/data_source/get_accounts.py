...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ErrorResponse | GetAccountsResponse200 | GetAccountsResponse400 | GetAccountsResponse401 | GetAccountsResponse429 | GetAccountsResponse500]
    """
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | GetAccountsResponse200 | GetAccountsResponse400 | GetAccountsResponse401 | GetAccountsResponse429 | GetAccountsResponse500
    """
