...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ErrorResponse | ListDataSourceLoginsResponse200 | ListDataSourceLoginsResponse401 | ListDataSourceLoginsResponse429 | ListDataSourceLoginsResponse500]
    """
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | ListDataSourceLoginsResponse200 | ListDataSourceLoginsResponse401 | ListDataSourceLoginsResponse429 | ListDataSourceLoginsResponse500
    """
