...
) -> DataResponse | GetDataResponse401 | GetDataResponse422 | GetDataResponse429 | GetDataResponse500 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DataResponse | GetDataResponse401 | GetDataResponse422 | GetDataResponse429 | GetDataResponse500]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        DataResponse | GetDataResponse401 | GetDataResponse422 | GetDataResponse429 | GetDataResponse500
    """
