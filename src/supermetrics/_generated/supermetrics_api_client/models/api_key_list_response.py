...
class ApiKeyListResponse:
    """Response envelope containing a list of API keys

    Attributes:
        meta (Meta | Unset): Metadata included in every API response.
        data (list[ApiKey] | Unset): List of API keys
    """

    meta: Meta | Unset = UNSET
    data: list[ApiKey] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ApiKey.from_dict(data_item_data)
