...
from ..models.blend_output_type import BlendOutputType, check_blend_output_type
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.blend_config_output import BlendConfigOutput
    from ..models.blend_output_blended_data_sources import BlendOutputBlendedDataSources


T = TypeVar("T", bound="BlendOutput")
...
class BlendOutput:
    ...
    Attributes:
        ...
        type_ (BlendOutputType | Unset): Blend type. Example: union.
        ...
        blended_data_sources (BlendOutputBlendedDataSources | Unset): Data sources included in this blend.
        config (BlendConfigOutput | Unset): Field mappings and join configuration for the blend (response). Union blends
            contain only `fields`; join blends also include `query_table` and `joins`.
    """

    blend_id: int | Unset = UNSET
    blend_uuid: UUID | Unset = UNSET
    type_: BlendOutputType | Unset = UNSET
    display_name: str | Unset = UNSET
    description: None | str | Unset = UNSET
    modified_time_utc: datetime.datetime | Unset = UNSET
    last_modify_user_email: str | Unset = UNSET
    blended_data_sources: BlendOutputBlendedDataSources | Unset = UNSET
    config: BlendConfigOutput | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: BlendOutputType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = check_blend_output_type(_type_)
        ...
        blended_data_sources: BlendOutputBlendedDataSources | Unset
        if isinstance(_blended_data_sources, Unset):
            blended_data_sources = UNSET
        else:
            blended_data_sources = BlendOutputBlendedDataSources.from_dict(_blended_data_sources)

        _config = d.pop("config", UNSET)
        config: BlendConfigOutput | Unset
        if isinstance(_config, Unset):
            config = UNSET
        else:
            config = BlendConfigOutput.from_dict(_config)
        ...
        blend_output.additional_properties = d
        return blend_output
