...
T = TypeVar("T", bound="CreateTeamApiKeyBody")


@_attrs_define
class CreateTeamApiKeyBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_team_api_key_body.additional_properties = d
        return create_team_api_key_body
