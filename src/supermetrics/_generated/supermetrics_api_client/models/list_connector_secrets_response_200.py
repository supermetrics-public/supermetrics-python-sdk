...
T = TypeVar("T", bound="ListConnectorSecretsResponse200")


@_attrs_define
class ListConnectorSecretsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_connector_secrets_response_200 = cls(
            count=count,
            secrets=secrets,
        )

        list_connector_secrets_response_200.additional_properties = d
        return list_connector_secrets_response_200
