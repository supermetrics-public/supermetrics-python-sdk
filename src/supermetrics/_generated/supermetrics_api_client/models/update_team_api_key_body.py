...
T = TypeVar("T", bound="UpdateTeamApiKeyBody")


@_attrs_define
class UpdateTeamApiKeyBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_team_api_key_body.additional_properties = d
        return update_team_api_key_body
