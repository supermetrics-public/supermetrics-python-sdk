...
T = TypeVar("T", bound="ValidationErrorsResponse")
...
class ValidationErrorsResponse:
    ...
    Attributes:
        is_valid (bool | Unset): Whether the configuration is valid Example: True.
        errors (list[ValidationError] | Unset): List of validation errors (empty if valid)
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        validation_errors_response = cls(
            is_valid=is_valid,
            errors=errors,
        )

        validation_errors_response.additional_properties = d
