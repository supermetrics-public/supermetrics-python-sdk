...
T = TypeVar("T", bound="WorkspaceListItem")
...
class WorkspaceListItem:
    ...
    Attributes:
        ...
        subscription (None | Unset | WorkspaceSubscriptionType0): Subscription details of the workspace, or null when
            none is active
        workspace_user_count (int | Unset): Number of users in the workspace Example: 4.
    """
    ...
    workspace_user_count: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        workspace_user_count = self.workspace_user_count
        ...
        if workspace_user_count is not UNSET:
            field_dict["workspace_user_count"] = workspace_user_count
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workspace_user_count = d.pop("workspace_user_count", UNSET)

        workspace_list_item = cls(
            id=id,
            parent_id=parent_id,
            team_id=team_id,
        ...
        workspace_list_item.additional_properties = d
        return workspace_list_item
